-- HZ Haroldas Zapalskis module install SQL file --
ALTER TABLE `oxarticles`
ADD `PRODUCTCLASS` ENUM( '0', '1', '2', '3', '4') NOT NULL
DEFAULT '0';

UPDATE `oxarticles` t SET t.`PRODUCTCLASS` = '1' WHERE t.`OXID` LIKE '058de8224773a1d5fd54d523f0c823e0';
